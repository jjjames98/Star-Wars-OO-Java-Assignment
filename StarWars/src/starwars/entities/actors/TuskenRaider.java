...
public class TuskenRaider extends SWActor {
	...
	/**
	 * Create a Tusken Raider. Tusken Raiders will randomly wander around the
	 * playfield (on any given turn, there is a 50% probability that they will
	 * move) and attack anything they can (if they can attack something, they
	 * will). They are all members of team TUSKEN, so their attempts to attack
	...
	public TuskenRaider(int hitpoints, String name, MessageRenderer m, SWWorld world) {
		...
		this.name = name;
		this.getForce().setCanUse(true);
		this.getForce().setForceAbility(1);
	}
